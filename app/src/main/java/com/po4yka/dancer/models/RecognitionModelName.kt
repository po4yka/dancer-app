...
enum class RecognitionModelName(
    ...
    MOVEMENT_LOTTERY_2_LEFT("3", R.string.lottery_2_left),
    MOVEMENT_LOTTERY_2_RIGHT("4", R.string.lottery_2_right),
    MOVEMENT_SAY_SO_1_LEFT("5", R.string.say_so_1_left),
    MOVEMENT_SAY_SO_1_RIGHT("6", R.string.say_so_1_right),
    MOVEMENT_WAP_1_LEFT("7", R.string.wap_1_left),
    MOVEMENT_WAP_1_RIGHT("8", R.string.wap_1_right),
    MOVEMENT_WAP_2("9", R.string.wap_2),
